...
const Home = () => {
  return (
    <main className="min-h-screen w-full overflow-hidden bg-gradient-to-br from-purple-100 via-white to-purple-200">
      {/* Decorative elements */}
      <div className="fixed top-[-10%] left-[-10%] w-[500px] h-[500px] rounded-full bg-purple-300/20 blur-3xl"></div>
      <div className="fixed bottom-[-10%] right-[-10%] w-[500px] h-[500px] rounded-full bg-purple-400/20 blur-3xl"></div>
